...
# FILE: ReimagineBoxscoresAsOO.R
# DATE 2025-10-26
# DESCRIPTION: 
# This R program performs Object-Oriented Programming (OOP) using the 
# S3 system to organize basketball statistics. It takes "flat" data 
# (a spreadsheet-style table) and converts it into a nested hierarchy 
# of "objects": a Game that contains two Teams, each containing a list 
# of Players.
