...
# FILE: BoxscoresTKinter.py
# DATE 2025-10-20
# DESCRIPTION: 
# This program creates a Python desktop application that displays 
# sports-related data (Boxscores, Players, and Teams) in three side-by-side 
# interactive lists. It is designed to act as a viewer for data stored in 
# a SQLite database.
