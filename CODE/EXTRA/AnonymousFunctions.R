...
# FILE: AnonymousFunctions.R
# DATE 2025-10-15
# DESCRIPTION: 
# This R program is a data analysis script that retrieves basketball 
# statistics from a local SQLite database and provides an interactive 
# menu for the user to view summaries, tables, or visualizations.
