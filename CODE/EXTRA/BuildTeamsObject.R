...
# FILE: BuildTeamsObject.R
# DATE 2025-10-16
# DESCRIPTION: 
# This R program is a specialized data extractor designed to retrieve 
# information from the "Teams" table of a SQLite database. It follows 
# a professional, modular design using R’s modern S7 object-oriented 
# system.
