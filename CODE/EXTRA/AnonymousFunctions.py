...
# DATE 2025-10-15
# DESCRIPTION:
# This Python program is an interactive data analysis tool that retrieves 
# basketball statistics from a SQLite database and allows the user to 
# choose between three different types of analysis.
