...
# FILE: BoxscoresPandastable.py
# DATE 2025-10-17
# DESCRIPTION: 
# This program integrates Python and R to fetch data and display it 
# in a desktop application. It uses R to retrieve specialized "Boxscores" 
# data and the Python library pandastable to show that data in a spreadsheet-like 
# GUI. 
