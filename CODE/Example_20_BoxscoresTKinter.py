...
class TripleListboxApp:
    ...
    def create_widgets(self):
        ...
        middle_frame = ttk.LabelFrame(main_frame, text="DataFrame 2", padding="5")
        middle_frame.grid(row=0, column=1, rowspan=2, padx=5, pady=5, sticky=(tk.W, tk.E, tk.N, tk.S))
        middle_frame.columnconfigure(0, weight=1)
        middle_frame.rowconfigure(0, weight=1)
        
        # middle listbox with scrollbar
        self.listbox2 = tk.Listbox(middle_frame, height=20, width=40)
        scrollbar2 = ttk.Scrollbar(middle_frame, orient=tk.VERTICAL, command=self.listbox2.yview)
        ...
        ###################################################################################################
        # Right listbox frame
        right_frame = ttk.LabelFrame(main_frame, text="DataFrame 3", padding="5")
        right_frame.grid(row=0, column=4, rowspan=2, padx=5, pady=5, sticky=(tk.W, tk.E, tk.N, tk.S))
        right_frame.columnconfigure(0, weight=1)
        right_frame.rowconfigure(0, weight=1)
        
        # Right listbox with scrollbar
        self.listbox3 = tk.Listbox(right_frame, height=20, width=40)
        scrollbar3 = ttk.Scrollbar(right_frame, orient=tk.VERTICAL, command=self.listbox3.yview)
        self.listbox3.config(yscrollcommand=scrollbar3.set)
        
        self.listbox3.grid(row=0, column=0, sticky=(tk.W, tk.E, tk.N, tk.S))
